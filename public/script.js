document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (field.tagName === 'SELECT' && isRequired && (value === '' || value === null)) {
  ...
  const OBSERVED_SELECTOR = '.fade-in, .slide-up, .slide-left, .slide-right, .scale-in, [data-animate]';
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Tape Reader uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '610df300-ffce-4c00-8dbd-70ca07e0d224',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '610df300-ffce-4c00-8dbd-70ca07e0d224';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '610df300-ffce-4c00-8dbd-70ca07e0d224';
